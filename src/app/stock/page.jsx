  ...
  const addStock = (producto) => {
    MySwal.fire({
      ...
      preConfirm: () => {
        ...
        const total = cantidad * valor_unidad;

        return { articuloId, cantidad, valor_unidad, tipo_pago, pagado, total };
      },
    }).then(async (result) => {
      if (result.isConfirmed) {
        const { articuloId, cantidad, valor_unidad, tipo_pago, pagado, total } =
          result.value;
