        ...
        <form id="productForm" class="bg-white p-6 rounded shadow-md w-full" style="max-width: 800px;">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
            <div>
              ...
              <select id="tipo" name="tipo" class="w-full px-3 py-2 border rounded" readonly disabled>
                <option value="Producto" ${
                  articulo && articulo.tipo === "Producto" ? "selected" : ""
                }>Producto</option>
                <option value="Mano de obra" ${
                  articulo && articulo.tipo === "Mano de obra" ? "selected" : ""
                }>Mano de obra</option>
              </select>
            </div>
            <div>
